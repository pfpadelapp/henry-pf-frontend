              ...
              <Box bg='blue.500'>
                <Box>
                  <Flex flexDirection='column' paddingBottom='2rem'>
                    <Heading>
                      Hola{' '}
                      <span style={{ color: '#98D035' }}>NombreUsuario</span>
                    </Heading>
                    <Heading size='lg'>bienvenido de nuevo!</Heading>
                  </Flex>
                  <Text>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Repudiandae explicabo ab labore laborum neque voluptas
                    placeat minima non.
                  </Text>
                </Box>
              </Box>
              <Box bg='blue.500'>
                <Text>Aca los filtros</Text>
                <Button>Agregar cancha</Button>
                <Button>Quitar cancha</Button>
                <Button>Actualizar cancha</Button>{' '}
              ...
              <Box>
                ...
                <Box>
                  <HStack gap='1rem' marginTop='2rem' bg='gray.300'>
                    <Avatar src={iconT1} />
                    <Text>
                      Torneo 1 Lorem ipsum dolor sit amet consectetur
                      adipisicing elit.
                    </Text>
                    <Badge variant='solid' color='#98D035'>
                      {' '}
                      12 miembros
                    </Badge>
                  </HStack>
                  <HStack gap='1rem' marginTop='2rem'>
                    <Avatar src={iconT2} />
                    <Text>
                      Torneo 2 Lorem ipsum dolor sit amet consectetur
                      adipisicing elit.
                    </Text>
                    <Badge variant='solid' color='#98D035'>
                      {' '}
                  ...
                  <HStack gap='1rem' margin='2rem 0'>
                    <Avatar src={iconT3} />
                    <Text>
                      Torneo 3 Lorem ipsum dolor sit amet consectetur
                      adipisicing elit.
                    </Text>
                    <Badge variant='solid' color='#98D035'>
                      {' '}
                      ...
                      <Tr>
                        <Td>
                          <Flex gap='1rem' alignItems='center'>
                            <Avatar
                              size='sm'
                              src='https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/styles/1200/public/media/image/2022/05/simpson-krusty-payaso-2699729.jpg?itok=leRSayV5'
                            />
                      ...
                      <Tr>
                        <Td>
                          <Flex gap='1rem' alignItems='center'>
                            <Avatar
                              size='sm'
                              src='https://pbs.twimg.com/media/ES3cH4QU8AALr8q.jpg'
                            />
                      ...
                      <Tr>
                        <Td>
                          <Flex gap='1rem' alignItems='center'>
                            <Avatar
                              size='sm'
                              src='https://uploads.candelaestereo.com/1/2022/06/12-frases-de-Rafa-Gorgory-muy-graciosas-y-extranas.01.jpg'
                            />
