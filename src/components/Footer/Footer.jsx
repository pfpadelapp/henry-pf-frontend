    ...
    <>
      ...
      <SimpleGrid
        ...
        <Stack
          ...
          <Flex flexDirection='row' alignItems='center' gap='10px'>
            ...
            <Text fontSize='medium' color='gray.500'>
              Calle falsa 123 Av. siempre viva 742
            </Text>
          </Flex>
          <Flex flexDirection='row' alignItems='center' gap='10px'>
            <IconButton
        ...
        <Stack
          ...
          <Flex flexDirection='row' alignItems='center' gap='10px'>
            <Link
              href='https://www.facebook.com/PadelField-App-106412448851655'
              isExternal>
              <IconButton
                variant='outline'
                color='#98D035'
      ...
      <Center>
        <Text padding='2rem 0' fontSize='medium' color='gray.500'>
          Copyright © 2022 PadelfieldApp. Todos los derechos reservados
        </Text>
      </Center>
    </>
  )
